...
public class Appendices_ {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < num_files; i++) {
            ...
            String finalTable = outputPath + File.separator + inputName + "_finalTable.csv";
            String tableLympho = outputPath + File.separator + inputName + "_tableLympho.csv";
            String tableArea = outputPath + File.separator + inputName + "_tableArea.csv";
